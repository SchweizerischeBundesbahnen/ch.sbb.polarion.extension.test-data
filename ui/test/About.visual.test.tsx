    ...
    installFetchMock([
      {
        ...
        match: /\/version$/,
        json: {
          bundleName: 'Test Data',
          bundleVendor: 'SBB',
          supportEmail: 'polarion-opensource@sbb.ch',
          automaticModuleName: 'ch.sbb.polarion.extension.test_data',
          bundleVersion: '1.0.0',
      ...
      },
      {
        ...
        json: {
          properties: [
            {
              key: 'ch.sbb.polarion.extension.test-data.some.property',
              value: 'value',
              defaultValue: 'value',
      ...
      },
      {
        ...
        json: [{ name: 'Test Data', status: 'OK', details: 'ready' }],
      },
      {
        method: 'GET',
        match: /\/readme$/,
        respond: () =>
          new Response('<h1>Test Data Extension for Polarion ALM</h1><p>Creates and removes test data.</p>', {
            status: 200,
          }),
      },
    ]);
